...
exports.authorizeUser = (req,res,next)=>{
    if(req.body.currentuser.role==="admin" || req.body.currentuser.role==="manager" )
    next()
    else 
    return res.status(404).send({msg: "Not Allowed to Access Only Admin and Manager Have Rights to Edit/Delete/Create"})
};